...
parser.add_argument('--video_path', help="Path of video file", default="hand.mp4")
parser.add_argument('--image_path', help="Path of image to detect objects", default="Images/bicycle.jpg")
parser.add_argument('--verbose', help="To print statements", default=True)
args = parser.parse_args()

def load_yolo():
  net = cv2.dnn.readNet("yolov3_custom2_final.weights", "yolov3_custom2.cfg")
  classes = []
  with open("obj.name.txt", "r") as f:
